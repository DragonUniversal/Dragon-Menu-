...
CreditLabel.Text = "Creator by:Vitorscript" .. (productInfo.Creator and productInfo.Creator.Name or "Unknown")
return
end
...
CreditLabel.Text = "Created by: Vitorscript"
...
CreditLabel.Text = "Created by:Vitorscript" .. (productInfo.Creator and productInfo.Creator.Name or "Unknown")
musicPlaying = true
end
end)
end
